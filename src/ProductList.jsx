...
function ProductList({ onHomeClick }) {
  ...
  const findItemInCart = (plant) => {
    const found = !!cart.items.find((item) => item.name === plant);
    return found;
  };
      ...
      {!showCart ? (
        <div className="product-grid">
          {plantsArray.map((plantGroup) => {
            return (
              <div key={plantGroup.category}>
                <div className="plant_heading">{plantGroup.category}</div>
                    ...
                    return (
                      <div className="product-card" key={plant.name}>
                        ...
                        <button
                          ...
                          disabled={findItemInCart(plant.name)}
